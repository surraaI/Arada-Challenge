...
async function display() {
    let html = ``
    await fetch("http://localhost:3001/challenges")
        .then(res => res.json())
        .then(data => {
          ...
          <div><img width="220rem" height="220rem" src= "${element.picturePath}"></div>
              ...
              <div scope="row" ><button style = "background-color: #2E8BC0; padding: 5px; color:white; font-size:25px;  border-radius:8px" class="update-btn">update</button></div>
