    ...
    let html=``
     await fetch("http://localhost:3000/salons")
      ...
      .then(data=>{
          ...
          <div class="bg-[#181A20] text-[#28C7A7] flex flex-col text-left w-[90vw] h-[100vh]">

          <div class="bg-[#181A20]" style ="font-size:25px;"><form id="form${element._id}"><input class='bg-[#181A20] input ' type="text" name='name' flex-1 "  required disabled value="${element.name}"></form></div>
          ...
          <input form="form${element._id}" class='input bg-[#181A20]' type="text" name="points" required disabled value="${element.points}">
          

          <div><img class="w-[90vw] h-[30vh]" src= "${element.picturePath}"></div>
...
//   button.innerHTML = "Click me again to decrease count";
